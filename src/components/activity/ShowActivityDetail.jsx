...
import ActivityBooking from '../booking-form/ActivityBooking';
...
function ShowActivityDetail({data}) {
    ...
    //             optionHandler(order.order, book.booking._id)
    //         }else{
  ...
  return (
    <>
               ...
               <div className='w-full z-50 fixed inset-0 overflow-y-auto'>
                 <ActivityBooking activity={data} bookingForm={setIsBookingForm} />
               </div>
               </>:''}
                   ...
                   <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 mt-10">
                       ...
                       <div className="lg:col-span-1">
                           <div className="sticky top-25 bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                               ...
                               <button onClick={()=> setIsBookingForm(!isBookingForm)} className="w-full py-3 bg-blue-600 text-white text-sm font-semibold rounded-lg hover:bg-blue-700 transition">
                                   Book Now
                               </button>
