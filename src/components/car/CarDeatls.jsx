...
Please let me know about the availability and booking process.`;
    ...
    const jsonLd = {
        ...
        "@type": "Product",
        "name": car.carName,
        url: `https://nylatravels.com/cars/${car.slug}`,
        "image": car.imageUrl.map(img => img.url),
