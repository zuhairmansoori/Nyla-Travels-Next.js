      ...
      className='bg-gray-100 overflow-hidden'>
         <div className='hero-text grid gap-10 lg:grid-cols-2 justify-center items-start w-full px-4 md:px-20 py-10 pb-20 justify-items-end'>
          <div className='flex flex-col gap-4 md:gap-6 justify-center items-center '>
            <HeadingMotion>
                 <div className='text-3xl md:text-5xl text-center p-10 pt-4  font-bold'>About <span className='text-primary'>Nyla </span><span className='text-secondary'>Travel</span></div>
            </HeadingMotion>
          ...
          <div className='relative   flex justify-center lg:justify-end items-center'>
            ...
            width={500}
            height={500}
            className='w-45  h-60 sm:w-90 sm:h-110 rounded-lg object-cover absolute top-30 sm:top-40 right-40 sm:right-50 shadow-image'
            />
         </div>
