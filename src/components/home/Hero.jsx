    ...
    <div>
      <div>
        <section className=' relative min-h-screen pb-32 '>
          <Image
            src='/heroimg5.png' alt='hero image' fill className='object-cover' />
            ...
            <div className="relative mx-auto flex min-h-screen max-w-7xl items-center px-4">
              <div className="w-full mt-15">
                <div className='pb-10 mt-24 md:m-0'>
                  <AnimatedText>
                           <h1 className="mb-4 max-w-full text-center text-4xl font-bold text-white md:text-6xl lg:text-7xl">
                  Discover Your Next Adventure
                </h1>
                 <p className="mb-8 max-w-full text-center text-lg lg:xl text-white/90">
